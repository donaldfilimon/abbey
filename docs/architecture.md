...
│  agent — ollama (default) · grok · fm · abi · Claude Code · optional cursor │
└─────────────────────────────────────────────────────────┘
```
...
5. **Tooling:** exact Rust nightly-2026-09-01 via `rust-toolchain.toml`, edition 2024; gate with `./check.sh`.
