...
The tool and its execution authority are absent from personal and MCP registries. No
client-selected tool registry, arbitrary shell, general daemon memory reads/search,
automation, or live event subscription is exposed. Windows named-pipe and
