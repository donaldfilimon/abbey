...
of that fixed route. No client-selected or mutating tool registry, arbitrary shell, daemon memory, automation,
approval, or live event subscription is exposed. Runtime schema v5 contains dormant
digest-bound approval transitions for future safe-edition authority; the daemon does not
negotiate those grants or register a mutating tool in this slice. Windows named-pipe and
