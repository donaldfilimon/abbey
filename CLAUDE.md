...
| `daemon/` / `bin/abbeyd.rs` | authenticated bounded Unix v1 reads, v2 startup-bound run control, and separate v3 safe tool/memory/claim plus conditional route- or manifest-derived model inventory; no arbitrary executable/argv/env/workspace |
