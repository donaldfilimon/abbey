...
const MIGRATION_1: &str = include_str!("migration_1_runtime_core.sql");

const MIGRATION_2: &str = include_str!("migration_2_legacy_conversations.sql");

const MIGRATION_3: &str = include_str!("migration_3_conversation_identity.sql");

const MIGRATION_4: &str = include_str!("migration_4_identity_mutations.sql");
