...
transcripts, memory, models, route/run data, and finalized backups. Reads remain
compatibility-mirror based until their own canonical-selection slice. This coordinator
adds no daemon command or protocol and is not the Proposed provider-neutral Abbey-owned
agent/tool runtime.
