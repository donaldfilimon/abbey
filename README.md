...
environment, workspace, tool, or shell. Additive protocol-v3 command, event, negotiation,
grant, and fixed-watermark types are available to implementers, but `abbeyd` does not yet
accept version 3 or advertise any v3 grant. Create a private bearer file and start it explicitly:
