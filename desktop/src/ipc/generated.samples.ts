...
export const DESKTOP_READ_CAPABILITIES = ["read_status","read_claims","read_routes","read_run","read_run_events","read_memory","read_models","read_claims_by_id"] as const;
