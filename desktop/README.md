...
Desktop source inventory: **11 enumerated commands · 7 read capabilities · 6 available views · 4 unavailable views**.

- Invoke IDs: `app_status`, `app_claims`, `app_routes`, `app_run_status`, `app_run_events`, `app_v3_grants`, `app_memory_search`, `app_memory_metadata`, `app_models_list`, `app_connection`, `app_bundle_identity`
