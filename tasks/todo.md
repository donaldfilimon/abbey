...
Canonical capability ledger: **33 Current · 2 Partial · 8 Proposed · 1 Blocked · 5 Out of scope** ([full evidence](../docs/claims.md)). Source: `src/claims.rs`; schema 1; digest `43783b6d411a2442db7253e8f4c1988a686bbd7a9e7c6cab93ab08e78f6a4b66`.
Executable workflow ledger: **26 goals (23 done, 1 in_progress, 1 proposed, 1 blocked) · 157 checked / 22 open todos** (stable goal metadata in `tasks/goals.md`).
