...
Canonical capability ledger: **33 Current · 2 Partial · 8 Proposed · 1 Blocked · 5 Out of scope** ([full evidence](../docs/claims.md)). Source: `src/claims.rs`; schema 1; digest `cac818b592a0bc512da678c223fd7f61f12ded3536db5190517b4270946e87b4`.
Executable workflow ledger: **26 goals (23 done, 1 in_progress, 1 proposed, 1 blocked) · 156 checked / 22 open todos** (stable goal metadata in `tasks/goals.md`).
