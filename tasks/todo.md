...
- [ ] **Phase 5 — Model and tool runtime ownership in ABI:**
  - [x] Object-safe ABI agent-runtime and host foundations: `ModelProvider`/`ModelRequest`/
    ...
    startup-owned provider objects; protocol-v3 tool authority remains open.
  - [x] First authenticated protocol-v3 daemon authority: a separate strict v3 envelope
    ...
    bounded fixed-watermark model inventory, and denies tools, approvals, memory,
