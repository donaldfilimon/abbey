...
Canonical capability ledger: **39 Current · 2 Partial · 8 Proposed · 1 Blocked · 5 Out of scope** ([full evidence](../docs/claims.md)). Source: `src/claims.rs`; schema 1; digest `281d90b640a7a84ccc79a58a51c22f2c121d7d776ed6d949faef22f511343ea2`.
Executable workflow ledger: **27 goals (24 done, 1 in_progress, 1 proposed, 1 blocked) · 166 checked / 25 open todos** (stable goal metadata in `tasks/goals.md`).
...
- [ ] **Desired-state execution:** remains a separate effect program requiring approvals,
      ...
      rollback proof. The C1 plans are data only and grant no execution authority.
