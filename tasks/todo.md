...
Canonical capability ledger: **35 Current · 2 Partial · 8 Proposed · 1 Blocked · 5 Out of scope** ([full evidence](../docs/claims.md)). Source: `src/claims.rs`; schema 1; digest `90ab8438e3c08de649d3d2ffd3325880f55efdc773fff025cff70ae7fadce2fd`.
Executable workflow ledger: **26 goals (23 done, 1 in_progress, 1 proposed, 1 blocked) · 163 checked / 22 open todos** (stable goal metadata in `tasks/goals.md`).
