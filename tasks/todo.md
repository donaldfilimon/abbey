...
Canonical capability ledger: **33 Current · 2 Partial · 8 Proposed · 1 Blocked · 5 Out of scope** ([full evidence](../docs/claims.md)). Source: `src/claims.rs`; schema 1; digest `b971b28800dc689130705a17997eeeab6dd8ec22e6b63f4b01a4bd2499a2e3d2`.
Executable workflow ledger: **26 goals (23 done, 1 in_progress, 1 proposed, 1 blocked) · 158 checked / 22 open todos** (stable goal metadata in `tasks/goals.md`).
