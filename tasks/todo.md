...
Canonical capability ledger: **35 Current · 2 Partial · 8 Proposed · 1 Blocked · 5 Out of scope** ([full evidence](../docs/claims.md)). Source: `src/claims.rs`; schema 1; digest `a5d3f2ee2de2ad005ec82996bb6bc201625ff060251c032649fd0781a9b5d3af`.
Executable workflow ledger: **26 goals (23 done, 1 in_progress, 1 proposed, 1 blocked) · 160 checked / 22 open todos** (stable goal metadata in `tasks/goals.md`).
