...
Canonical capability ledger: **36 Current · 2 Partial · 8 Proposed · 1 Blocked · 5 Out of scope** ([full evidence](../docs/claims.md)). Source: `src/claims.rs`; schema 1; digest `935ead57e4c4196fe124a346ee69d9c6b8ebed3292b4c22f55fa0193ec2f719d`.
...
- [ ] **Phase 5 — Model and tool runtime ownership in ABI:**
  ...
  - [x] `abi-models` and `abi-model-runtime` foundations: Candle + safetensors, CPU and Metal first, CUDA
    ...
    `abi-bigram-v1` fixture; Abbey has no enabled production prompt-inference route yet.
  - [x] Signed protocol-v3 model lifecycle: an edition-scoped owner-only startup
    ...
    are committed. Prompt inference, production Gemma, live HTTPS publisher evidence,
