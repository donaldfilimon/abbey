...
Canonical capability ledger: **32 Current · 2 Partial · 8 Proposed · 1 Blocked · 5 Out of scope** ([full evidence](../docs/claims.md)). Source: `src/claims.rs`; schema 1; digest `e7eab58d38cd082af7135b7db937d8320a3e0de3b86ca7c2c3e6cbf964e51f1c`.
Executable workflow ledger: **26 goals (23 done, 1 in_progress, 1 proposed, 1 blocked) · 121 checked / 20 open todos** (stable goal metadata in `tasks/goals.md`).
...
next-action: Repair the warning-denied rustdoc gate and current ledger/document drift before broadening provider-neutral runtime authority.
-->
