...
Canonical capability ledger: **33 Current · 2 Partial · 8 Proposed · 1 Blocked · 5 Out of scope** ([full evidence](../docs/claims.md)). Source: `src/claims.rs`; schema 1; digest `94de2163f599b10fd9f145b59b0ff399a152958020566bd2bcaeef09d25340e1`.
Executable workflow ledger: **26 goals (23 done, 1 in_progress, 1 proposed, 1 blocked) · 153 checked / 22 open todos** (stable goal metadata in `tasks/goals.md`).
