...
Canonical capability ledger: **32 Current · 2 Partial · 8 Proposed · 1 Blocked · 5 Out of scope** ([full evidence](../docs/claims.md)). Source: `src/claims.rs`; schema 1; digest `0a9519e5bfd42534e819618290fadfba2aeeb47b94fa07e4f1b2bfb055e10154`.
Executable workflow ledger: **26 goals (23 done, 1 in_progress, 1 proposed, 1 blocked) · 122 checked / 20 open todos** (stable goal metadata in `tasks/goals.md`).
...
next-action: Synchronize the historical Phase 2 status and generated desktop capability documentation before broadening provider-neutral runtime authority.
-->
