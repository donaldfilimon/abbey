...
Canonical capability ledger: **32 Current · 2 Partial · 8 Proposed · 1 Blocked · 5 Out of scope** ([full evidence](../docs/claims.md)). Source: `src/claims.rs`; schema 1; digest `9bd5dc6429baf7e7962dac592a58388548aa3f03518719935fafd12bc8f840a4`.
Executable workflow ledger: **26 goals (23 done, 1 in_progress, 1 proposed, 1 blocked) · 124 checked / 20 open todos** (stable goal metadata in `tasks/goals.md`).
...
next-action: Make accelerator installation transactional and prove the installed binary uses a verified loader-relative ABI Metal dylib from an isolated destination.
-->
