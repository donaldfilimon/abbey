...
Canonical capability ledger: **32 Current · 2 Partial · 8 Proposed · 1 Blocked · 5 Out of scope** ([full evidence](../docs/claims.md)). Source: `src/claims.rs`; schema 1; digest `788076abd06d3d68c392cc3779b0ea2b71a3e72c3c4f58b72bc8f41dcc77be28`.
Executable workflow ledger: **26 goals (23 done, 1 in_progress, 1 proposed, 1 blocked) · 142 checked / 22 open todos** (stable goal metadata in `tasks/goals.md`).
...
next-action: Implement fixed-recipe Cursor, Grok, ABI-local, and Foundation Models adapters behind the pinned ABI ModelProvider contract, then add the explicit local-model route only under protocol v3; preserve byte-compatible protocol v1/v2 authority.
-->
