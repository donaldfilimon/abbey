...
next-action: Add served model download, load/unload, and inference status behind exact startup-owned registry authority without implicit model selection.
-->
