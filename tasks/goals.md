...
Canonical capability ledger: **32 Current · 2 Partial · 8 Proposed · 1 Blocked · 5 Out of scope** ([full evidence](../docs/claims.md)). Source: `src/claims.rs`; schema 1; digest `d181b4d6e2f243228dc62b8e9cff9ebe834e79cc46a97ab3bd967231360828ae`.
Executable workflow ledger: **26 goals (23 done, 1 in_progress, 1 proposed, 1 blocked) · 123 checked / 20 open todos** (stable goal metadata in `tasks/goals.md`).
...
next-action: Make daemon connection handoff and process-group reaping deterministic under injected scheduler and teardown races.
-->
