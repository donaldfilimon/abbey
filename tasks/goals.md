...
Canonical capability ledger: **33 Current · 2 Partial · 8 Proposed · 1 Blocked · 5 Out of scope** ([full evidence](../docs/claims.md)). Source: `src/claims.rs`; schema 1; digest `eb0ec216033405adaf916225a6b60bc059e61b49923cd602aa2b4683deb9655a`.
Executable workflow ledger: **26 goals (23 done, 1 in_progress, 1 proposed, 1 blocked) · 152 checked / 22 open todos** (stable goal metadata in `tasks/goals.md`).
...
next-action: Add durable typed approval, denial, expiry, and cancellation state without registering a mutating, personal-shell, remote, or desktop tool.
-->
