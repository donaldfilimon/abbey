...
Canonical capability ledger: **33 Current · 2 Partial · 8 Proposed · 1 Blocked · 5 Out of scope** ([full evidence](../docs/claims.md)). Source: `src/claims.rs`; schema 1; digest `32cd8dc43df79534b500cf742a38ee9cce4454cd0f2d0a1c52bf16ccd932c957`.
Executable workflow ledger: **26 goals (23 done, 1 in_progress, 1 proposed, 1 blocked) · 148 checked / 22 open todos** (stable goal metadata in `tasks/goals.md`).
