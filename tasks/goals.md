...
Executable workflow ledger: **26 goals (23 done, 1 in_progress, 1 proposed, 1 blocked) · 135 checked / 23 open todos** (stable goal metadata in `tasks/goals.md`).
...
next-action: Continue Train 1.6 with a behavior-preserving extraction from src/runtime/supervisor.rs, then close src/daemon/server.rs and retain the 1,000-line hard failure.
-->
