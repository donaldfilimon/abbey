...
Executable workflow ledger: **26 goals (23 done, 1 in_progress, 1 proposed, 1 blocked) · 125 checked / 20 open todos** (stable goal metadata in `tasks/goals.md`).
...
next-action: Decompose every production Rust module above the 800-line soft cap through behavior-preserving extractions while retaining the 1,000-line hard failure.
-->
