...
Canonical capability ledger: **30 Current · 1 Partial · 8 Proposed · 1 Blocked · 5 Out of scope** ([full evidence](../docs/claims.md)). Source: `src/claims.rs`; schema 1; digest `3084c6ce170eb5db5d3e04fd31164a8f0963a2195be7a200a8625c4144e1e63b`.
Executable workflow ledger: **26 goals (23 done, 1 in_progress, 1 proposed, 1 blocked) · 120 checked / 20 open todos** (stable goal metadata in `tasks/goals.md`).
