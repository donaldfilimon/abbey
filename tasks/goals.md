...
Canonical capability ledger: **33 Current · 2 Partial · 8 Proposed · 1 Blocked · 5 Out of scope** ([full evidence](../docs/claims.md)). Source: `src/claims.rs`; schema 1; digest `cafbacdc4c1578d50c220f19e134234c91591f328f9888a0fb307acc7ba8b348`.
Executable workflow ledger: **26 goals (23 done, 1 in_progress, 1 proposed, 1 blocked) · 154 checked / 22 open todos** (stable goal metadata in `tasks/goals.md`).
