...
Canonical capability ledger: **33 Current · 2 Partial · 8 Proposed · 1 Blocked · 5 Out of scope** ([full evidence](../docs/claims.md)). Source: `src/claims.rs`; schema 1; digest `ebf6b26f1f4291ea67191685d8fff9c7db23be8e3ef2da4566dba723dd76b41d`.
Executable workflow ledger: **26 goals (23 done, 1 in_progress, 1 proposed, 1 blocked) · 151 checked / 22 open todos** (stable goal metadata in `tasks/goals.md`).
