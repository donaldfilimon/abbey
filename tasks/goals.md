...
Canonical capability ledger: **33 Current · 2 Partial · 8 Proposed · 1 Blocked · 5 Out of scope** ([full evidence](../docs/claims.md)). Source: `src/claims.rs`; schema 1; digest `08763afe3f5dd76dddaa85c965d14ca6523dfbae4cb9be2efb3fd914bd2b4bf8`.
Executable workflow ledger: **26 goals (23 done, 1 in_progress, 1 proposed, 1 blocked) · 147 checked / 22 open todos** (stable goal metadata in `tasks/goals.md`).
