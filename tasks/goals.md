...
Canonical capability ledger: **32 Current · 2 Partial · 8 Proposed · 1 Blocked · 5 Out of scope** ([full evidence](../docs/claims.md)). Source: `src/claims.rs`; schema 1; digest `bba8a2bd6d2679c5477a66d5a3cfcee105284a60148325c42310f93d2c4a7fc1`.
...
next-action: Reproduce the suspected shared-state conversation recovery failure before attempting the isolation repair.
-->
