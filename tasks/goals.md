...
Executable workflow ledger: **26 goals (23 done, 1 in_progress, 1 proposed, 1 blocked) · 138 checked / 20 open todos** (stable goal metadata in `tasks/goals.md`).
...
next-action: Start Train 2 in a clean ABI origin/main worktree by reconciling the board with the already-merged abi-agent-runtime and abi-models foundations, recording their exact negative boundaries, and running ./tools/check.sh.
-->
