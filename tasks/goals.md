...
Canonical capability ledger: **29 Current · 1 Partial · 8 Proposed · 1 Blocked · 5 Out of scope** ([full evidence](../docs/claims.md)). Source: `src/claims.rs`; schema 1; digest `3cc580b08a702a320e2d77376d18d514aa248dd7a97b1faa67a5b33869d09f0b`.
Executable workflow ledger: **26 goals (23 done, 1 in_progress, 1 proposed, 1 blocked) · 118 checked / 20 open todos** (stable goal metadata in `tasks/goals.md`).
