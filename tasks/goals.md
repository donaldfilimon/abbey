...
next-action: Introduce protocol v3 negotiation and deny-by-default capability grants, then expose an explicit ABI-local-model route only through v3 while preserving byte-compatible protocol v1/v2 authority.
-->
