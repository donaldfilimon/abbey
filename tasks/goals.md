...
Executable workflow ledger: **26 goals (23 done, 1 in_progress, 1 proposed, 1 blocked) · 127 checked / 31 open todos** (stable goal metadata in `tasks/goals.md`).
...
next-action: Continue Train 1.6 with a behavior-preserving extraction from src/runtime/store/tests.rs, then close the remaining nine over-cap modules while retaining the 1,000-line hard failure.
-->
