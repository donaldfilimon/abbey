...
next-action: Continue Train 1.6 with a behavior-preserving extraction from src/memory/sqlite.rs, then close the remaining three over-cap modules while retaining the 1,000-line hard failure.
-->
