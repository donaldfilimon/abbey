...
Executable workflow ledger: **26 goals (23 done, 1 in_progress, 1 proposed, 1 blocked) · 145 checked / 22 open todos** (stable goal metadata in `tasks/goals.md`).
