...
- **A save-path cutover does not prove read or clear semantics.** Keep `read_chat_for`
  and `clear_chat` outside the canonical-write Current boundary until canonical read
  selection and tombstones have their own focused and real-process evidence.
